...
export class CreditRepository extends BaseRepository<CreditPayments> {
  ...
  async findAll(
    options?: FindOptions<CreditPayments> | undefined,
  ...
  async create(
    data: CreateData<CreditPayments>,
    txOptions?: TransactionOptions,
  ): Promise<CreditPayments> {
    try {
  ...
  async update(
    id: number | string,
    data: Partial<CreateData<CreditPayments>>,
    txOptions?: TransactionOptions,
  ): Promise<CreditPayments | null> {
    try {
  ...
  async count(
    where?: Partial<CreditPayments["_attributes"]>,
    txOptions?: TransactionOptions,
  ): Promise<number> {
    try {
